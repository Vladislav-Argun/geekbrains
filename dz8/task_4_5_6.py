...
class StoreMashines:
    ...
    def __init__(self, name, price, quantity, number_of_lists, *args):
        ...
        self.my_store_full = []
        self.my_store = []
        self.my_unit = {'Модель устройства': self.name, 'Цена за еденицу': self.price, 'Количество': self.quantity}
    ...
    def reception(self):
        try:
            ...
            unique = {'Модель устройства': unit, 'Цена за еденицу': unit_p, 'Количество': unit_q}
...
unit_1 = Printer('hp', 1500, 2, 5)
unit_2 = Scanner('Canon', 1800, 2, 5)
unit_3 = Copier('Xerox', 1300, 1, 10)
